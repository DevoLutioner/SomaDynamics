...
1. 下载 `SomaDynamics_1.0.2.1-with-MMD-Stabilizer-v1.2.1.zip`。
...
不使用 MMD 时，只安装 `SomaDynamics_1.0.2.1.zip` 即可。只需要修复 MMD 头发或裙摆时，
...
- 从 1.0.2.1 起，Studio/Timeline 换角色、换服装、切换或重播动作时只撤销 Soma 自身
