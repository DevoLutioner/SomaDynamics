# Soma Dynamics｜形体动力学控制器 v1.0.3.8
...
| 版本 | 用户可见修复 |
| --- | --- |
| 1.0.3.8 | 升级 Chain 低频回弹曲线并提高默认 Thigh 弹性；不增加粒子循环开销，恢复更明显的摆动响应。 |
...
- `packaging\SomaDynamics_1.0.3.8\`
- `packaging\SomaDynamics_1.0.3.8.zip`
- `packaging\SomaDynamics_1.0.3.8.zip.sha256`
