...
├─ packaging\SomaDynamics_1.0.2.2\ 发行目录（含 README.zh-CN.md、CHANGELOG.md）
├─ packaging\SomaDynamics_1.0.2.2.zip + .sha256
├─ README.md                        用户/功能说明
├─ CHANGELOG.md                     更新日志
└─ DEVELOPMENT.md                   本文档
```
...
产物：`packaging\SomaDynamics_1.0.2.2\`、ZIP、SHA-256。构建脚本会做版本、UI、
胸臀 Spring 清除和原生链实时应用安全契约检查。

## 安装与测试

- 安装：把 `packaging\SomaDynamics_1.0.2.2\BepInEx\plugins\ThighPhysicsController\`
