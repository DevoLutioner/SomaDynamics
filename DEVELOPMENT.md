...
├─ packaging\SomaDynamics_1.0.1.0\ 发行目录（含 README.zh-CN.md、CHANGELOG.md）
...
产物：`packaging\SomaDynamics_1.0.1.0\`、ZIP、SHA-256。构建脚本会做版本、UI、
胸臀 Spring 清除和原生链实时应用安全契约检查。

## 安装与测试

- 安装：把 `packaging\SomaDynamics_1.0.1.0\BepInEx\plugins\ThighPhysicsController\`
