...
if (-not $SkipTests) {
    & powershell -NoProfile -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'Test-FleshPerformanceRegression.ps1')
    if ($LASTEXITCODE -ne 0) {
        throw "Performance regression test failed with exit code $LASTEXITCODE"
    }
